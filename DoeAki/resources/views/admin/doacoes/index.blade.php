        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="searchFilter" placeholder="Item ou usuário..." onkeyup="filterDoacoes()">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            @if($doacoes->count() > 0)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            @if($doacao->status == 'pendente')
                                                ...
                                                <button type="button" class="btn btn-danger" onclick="showRejeitarModal({{ $doacao->id }})" title="Rejeitar doação">
                                                    <i data-lucide="x"></i> Rejeitar
                                                </button>
                                            @elseif($doacao->status == 'aceita' && $doacao->status != 'entregue')
                                                <form action="{{ route('admin.doacoes.entregue', $doacao->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                            ...
                                            <a href="{{ route('admin.doacoes.show', $doacao->id) }}" class="btn btn-outline-primary" title="Ver detalhes">
                                                <i data-lucide="eye"></i>
                                            </a>
                                        </div>
                                    </td>
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div>
                        Mostrando {{ $doacoes->firstItem() }} a {{ $doacoes->lastItem() }} de {{ $doacoes->total() }} registros
                    </div>
                    <div>
                        {{ $doacoes->links() }}
                    </div>
